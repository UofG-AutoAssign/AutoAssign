...
| ------------- | ------------- | ------------- |
| ![image info](./images/login-page.png) | ![image info](./images/skills-preference-form-page.png) |  ![image info](./images/team-settings-page.png)              |

| HR Account: Create Graduate Account Page  | HR Account: Manage Teams Page | HR Account: AutoAssign Page |
| ------------- | ------------- | ------------- |
| ![image info](./images/create-graduate-account-page.png)  |  ![image info](./images/manage-teams-page.png)  |  ![image info](./images/auto-assign-page.png)              |
...
-	How the AutoAssign Algorithm works
	...
	![image info](./images/algorithm-diagram.png)
