...
const LandingButton: React.FC<LandingButtonProps> = ({
  ...
  return (
    <button
      className={`${btn_color} h-36 flex flex-col w-3/4 mx-auto min-h-40 p-5 rounded-2xl hover:scale-110 transition-all delay-100 focus:border-black focus:border-2`}
    >
